...
if deviances_pn:
    plt.plot(
        range(0, plotter.it, 10),
        deviances_pn,
        label="Deviance POS and NEG",
        linestyle="--",
    )
    plt.plot(
        range(0, plotter.it, 10),
        medians_pn,
        label="Median Bootstrap POS and NEG",
        linestyle="-.",
    )
if deviances_p:
    plt.plot(
        range(0, plotter.it, 10), deviances_p, label="Deviance POS", linestyle="--"
    )
